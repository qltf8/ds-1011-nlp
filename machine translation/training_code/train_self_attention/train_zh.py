#the code is adapted from http://nlp.seas.harvard.edu/2018/04/03/attention.html#conclusion
import numpy as np
...
train_vi_en = torchtext.data.TabularDataset('/home/ql819/text_data/train_zh_en.csv', format='csv', 
                             fields=[('source',TEXT_vi),('target',TEXT_en)])
validation_vi_en = torchtext.data.TabularDataset('/home/ql819/text_data/dev_zh_en.csv', format='csv', 
                             fields=[('source',TEXT_vi),('target',TEXT_en)])


TEXT_vi.build_vocab(train_vi_en, min_freq=5)
...
save_model_dir_name = '../save_model/self_attention_zh_to_en_'
model = EncoderDecoder(512, 64, 2, 2, len(TEXT_vi.vocab.stoi), len(TEXT_en.vocab.stoi), 0.1).cuda()
model.init_model()
...
save_model_dir_name = '../save_model/refined_self_attention_zh_to_en_'
